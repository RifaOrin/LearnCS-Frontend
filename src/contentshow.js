...
const quizattempUrl =
    "https://kasifzisan.pythonanywhere.com/course/2/module/10/quiz/3/quizAttempt/";
    ...
    return (
        <body className="min-h-screen">
            ...
            <div className=" flex flex-row">
                <div
                    className="h-screen flex flex-col pt-14 pl-14 mr-4 w-1/4 overflow-y-auto border-y shadow-lg "
                    style={{ height: "85vh" }}
                >
                    {modules.map((module) => (
                                ...
                                <div>
                                    {video.length > 0 && (
                                        <ul>
                                            {video.map((item) => (
                                                <li
                                                    className="flex flex-row items-center space-x-2 pt-3 pb-2"
                                                    key={item.id}
                                                >
                                                    <IonIcon
                                    ...
                                    {pdf.length > 0 && (
                                        <ul>
                                            {pdf.map((item) => (
                                                <li
                                                    className="flex flex-row items-center space-x-2 pt-2 pb-2"
                                                    key={item.id}
                                                >
                                                    <IonIcon
                                                        icon={readerOutline}
                ...
                <div className="w-3/4">
                    <div>
                        {selectedPdf && (
                            <div
                                className="h-1/3 w-11/12 border rounded-lg shadow p-4 mb-4"
                                style={{ height: "85vh" }}
                            >
                    ...
                    <div>
                        {selectedVideo && (
                            <div className="p-6">
                                <h1 className=" text-4xl font-medium mb-10 mt-10 ml-14 ">
                                    {videoTitle}
                                </h1>
                            ...
                            <div className="pl-10 pr-10 pt-20">
                                ...
                                <div className="flex items-center justify-between mt-20 pt-6 pb-6 border-t-2 border-b-2">
                                    ...
                                    {isAttemp ?  (
                                        ...
                                        >
                                            <button class="ml-auto bg-[#13974c] hover:bg-[#0dc55d] text-white text-base font-medium rounded px-4 py-2">
                                                Retake Quiz
                                            </button>
                                        </Link>
                                    ) : (
                                ...
                                <div className="flex items-center justify-between pt-6 pb-6 border-b-2">
                                    ...
                                    <div className="flex flex-col space-y-3 border-l-2 pl-5">
                                        <p className="ml-auto pr-3 text-base font-medium">
                                            Your grade
                                        </p>
                                        <p>{quizMark}</p>
                                    </div>
